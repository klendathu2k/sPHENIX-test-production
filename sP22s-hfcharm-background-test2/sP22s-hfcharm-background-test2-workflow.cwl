...
steps:
  Pythia8MinbSimulation:
    ...
    in:
        ...
        opt_args:
          default: " --nJobs 100  --maxAttempt 1  --memory 8192  --maxWalltime 48  --cpuTimePerEvent 2000000  --outputs Pythia8MinbSimulation.outDS.tar  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
