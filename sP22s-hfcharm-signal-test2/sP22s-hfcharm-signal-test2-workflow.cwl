...
steps:
  Pythia8CharmSimulation:
    ...
    in:
        ...
        opt_args:
          default: " --nJobs 500  --maxAttempt 1  --memory 8192  --maxWalltime 48  --cpuTimePerEvent 2000000  --outputs Pythia8CharmSimulation.outDS.tar  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
