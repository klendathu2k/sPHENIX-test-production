...
steps:
  Pythia8CharmSimulation:
    ...
    in:
        opt_exec:
          default: "Pythia8CharmSimulation.sh  %RNDM:2000 >& _Pythia8CharmSimulation.log "
        opt_args:
  ...
  Pythia8MinbSimulation:
    ...
    in:
        opt_exec:
          default: "Pythia8MinbSimulation.sh  %RNDM:2000 >& _Pythia8MinbSimulation.log "
        opt_args:
  ...
  Pythia8CharmPileup:
    ...
    in:
        ...
        opt_exec:
          default: "Pythia8CharmPileup.sh  %RNDM:2000 %IN %IN2 >& _Pythia8CharmPileup.log "
        opt_args:
  ...
  Pythia8Calorimeter:
    ...
    in:
        ...
        opt_exec:
          default: "Pythia8Calorimeter.sh  %RNDM:2000 %IN >& _Pythia8Calorimeter.log "
        opt_args:
  ...
  Pythia8Pass3Track:
    ...
    in:
        ...
        opt_inDsType:
          default: Pythia8Pileup.outDS.tar
        opt_exec:
          default: "Pythia8Pass3Track.sh  %RNDM:2000 %IN >& _Pythia8Pass3Track.log "
        opt_args:
  ...
  Pythia8Pass4Track:
    ...
    in:
        ...
        opt_exec:
          default: "Pythia8Pass4Track.sh  %RNDM:2000 %IN >& _Pythia8Pass4Track.log "
        opt_args:
  ...
  mergeOutputs:
    ...
    in:
        ...
        opt_exec:
          default: "mergeOutputs.sh  %RNDM:2000 %IN %IN2 >& _mergeOutputs.log "
        opt_args:
