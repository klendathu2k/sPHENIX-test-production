...
steps:
  Pythia8MinbSimulation:
    ...
    in:
        ...
        opt_args:
          default: " --nJobs 50  --maxAttempt 3  --memory 8192  --maxWalltime 48  --cpuTimePerEvent 1000  --outputs Pythia8MinbSimulation.outDS.tar  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
