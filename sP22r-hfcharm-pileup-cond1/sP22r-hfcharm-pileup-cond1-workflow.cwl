...
steps:
  Pythia8CharmPileup:
    ...
    in:
        ...
        opt_args:
          default: " --nFiles 10  --maxAttempt 5  --memory 8192  --outputs Pythia8Pileup.outDS.tar  --nFilesPerJob=1 --secondaryDSs IN2:99:%{DS1} --reusableSecondary IN2 --forceStaged  --forceStagedSecondary  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
  ...
  Pythia8Pass4TrackStage0:
    ...
    in:
        ...
        opt_exec:
          default: "Pythia8Pass4TrackStage0.sh  %RNDM:0 %IN >& _Pythia8Pass4TrackStage0.log "
        opt_args:
  ...
  Pythia8Pass4TrackStageA:
    ...
    in:
        ...
        opt_exec:
          default: "Pythia8Pass4TrackStageA.sh  %RNDM:0 %IN >& _Pythia8Pass4TrackStageA.log "
        opt_args:
  ...
  Pythia8Pass4TrackStageC:
    ...
    in:
        ...
        opt_exec:
          default: "Pythia8Pass4TrackStageC.sh  %RNDM:0 %IN >& _Pythia8Pass4TrackStageC.log "
        opt_args:
          default: " --maxAttempt 1  --outputs Pythia8Pass4TrackStageC.outDS.tar  --nFilesPerJob=1 --forceStaged  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
  ...
  mergeOutputs:
    ...
    in:
        ...
        opt_exec:
          default: "mergeOutputs.sh  %RNDM:0 %IN %IN2 >& _mergeOutputs.log "
        opt_args:
