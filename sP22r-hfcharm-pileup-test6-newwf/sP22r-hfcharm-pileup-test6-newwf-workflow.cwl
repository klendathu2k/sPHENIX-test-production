...
# Pythia8Pass4TrackStageC : output=Pythia8Pass4TrackStageC/outDS
outputs:
  outDS:
    type: string
    outputSource: Pythia8CharmOutput/outDS
    outputSource: Pythia8Pass4TrackStageC/outDS
...
steps:
  Pythia8CharmPileup:
    ...
    in:
        ...
        opt_args:
          default: " --maxAttempt 5  --memory 8192  --outputs Pythia8Pileup.outDS.tar  --nFilesPerJob=1 --secondaryDSs IN2:100:%{DS1} --reusableSecondary IN2 --forceStaged  --forceStagedSecondary  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
