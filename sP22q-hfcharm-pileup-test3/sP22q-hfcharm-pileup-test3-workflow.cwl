...
steps:
  Pythia8CharmPileup:
    ...
    in:
        ...
        opt_args:
          default: " --nFiles 50  --maxAttempt 5  --memory 8192  --outputs Pythia8Pileup.outDS.tar  --nFilesPerJob=1 --secondaryDSs IN2:50:%{DS1} --reusableSecondary IN2 --forceStaged  --forceStagedSecondary  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
