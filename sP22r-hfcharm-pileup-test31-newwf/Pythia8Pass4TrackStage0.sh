...
cp -R __Pythia8Pass4TrackStage0/* .
echo $@
...
export shrek_tag=sP22r-hfcharm-pileup-test31-newwf
export name=Pythia8Pass4TrackStage0
export build=ana.315
export comment=This is a test job definition
export macro=Fun4All_G4_sPHENIX_job0.C
export flavor=Charm
export nEvents=10
export maxAttempt=3
export runnumber=1
...
outfile=HF_pp200_signal_pass4_job0_${rn}-${sn}.root
...
tar cvf Pythia8Pass4TrackStage0.outDS.tar *.root 
ls 
