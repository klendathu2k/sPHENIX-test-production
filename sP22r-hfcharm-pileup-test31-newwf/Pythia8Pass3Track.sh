...
outfile=HF_pp200_signal_pass3trk_${rn}-${sn}.root

echo   root.exe -q -b  Fun4All_G4_Pass3Trk.C\(${nEvents},\"${dst_track}\",\"${dst_truth}\",\"\",\"\",0,\".\",\"${flavor}\"\)
root.exe -q -b  Fun4All_G4_Pass3Trk.C\(${nEvents},\"${dst_track}\",\"${dst_truth}\",\"\",\"\",0,\".\",\"${flavor}\"\)
