...
steps:
  Pythia8MinbSimulation:
    ...
    in:
        opt_exec:
          default: "Pythia8MinbSimulation.sh  %RNDM:200000 >& _Pythia8MinbSimulation.log "
        opt_args:
          default: " --nJobs 3101  --maxAttempt 3  --memory 8192  --maxWalltime 48  --cpuTimePerEvent 75000  --outputs Pythia8MinbSimulation.outDS.tar  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
  ...
  FinishMinbSimu:
    ...
    in:
        ...
        opt_exec:
          default: "FinishMinbSimu.sh  %RNDM:200000 %IN >& _FinishMinbSimu.log "
        opt_args:
