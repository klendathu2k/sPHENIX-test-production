...
steps:
  Pythia8MinbSimulation:
    ...
    in:
        ...
        opt_args:
          default: " --nJobs 2000  --maxAttempt 3  --memory 8192  --maxWalltime 48  --cpuTimePerEvent 75000  --outputs Pythia8MinbSimulation.outDS.tar  --site BNL_OSG_SPHENIX --avoidVP --noBuild "
    out: [outDS]
